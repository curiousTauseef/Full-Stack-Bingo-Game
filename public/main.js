...
bingo.addEventListener('click', function () {
    ...
    num[19].value == "1" && num[20].value == "1"){
        ...
        alert("Congrats!!!! Raise Your Hand And Wait For Personal To Verify");
    }
})
...
$('#bing21').on('click',function() {
  $('#num21').toggleClass('checked')
})
$('#bing22').on('click',function() {
  $('#num22').toggleClass('checked')
})
$('#bing23').on('click',function() {
  $('#num23').toggleClass('checked')
})
$('#bing24').on('click',function() {
  $('#num24').toggleClass('checked')
})
$('#bing25').on('click',function() {
  $('#num25').toggleClass('checked')
})
